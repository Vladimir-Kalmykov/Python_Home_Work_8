...
# Трансформируем справочник из файла в список из словарей
...
# Выполняем функции с телефонной книгой в завасимости от выбранного пункта меню
...
def delete_user(phone_book):
    user = input(
        'Введите фамилию или имя абонента,которого необходимо удалить: ')
    for elem in phone_book:
